...
export default function SignUp() {
    return (
        <>
            <div className={style.sign_up_form} data-theme="light">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                    ...
                    <div className='w-full' id='sobrenome'>
                        <label className="input validator w-full">
                    ...
                    <div className='w-full' id='telefone'>
                        <label className="input validator w-full">
                    ...
                    {/* E-mail */}
                    <div className='col-span-2' id='email'>
                        <label className="input validator w-full">
                            <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <p className="validator-hint hidden">Digite um e-mail válido.</p>
                    </div>
